...
local layout = Layout.new{
	...
	Layout.new{
		id = "scrbg",
		cellRelH = 1/5,
		Layout.new{row = 0, sprM = Layout.LETTERBOX,
			TextField.new(font, "texM = Layout.CROP", "|"),
		},
		Layout.new{row = 1, sprM = Layout.LETTERBOX,
			TextField.new(font, "texAncX = 0.75", "|"),
		},
		Layout.new{row = 2, sprM = Layout.LETTERBOX,
			TextField.new(font, "texAncY = 0.25", "|"),
		},
		Layout.new{row = 3, sprM = Layout.LETTERBOX,
			TextField.new(font, "texS = 0.125", "|"),
		},
		Layout.new{row = 4, sprM = Layout.LETTERBOX,
